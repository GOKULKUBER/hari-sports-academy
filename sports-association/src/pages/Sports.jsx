  ...
  return (
    ...
    >
      <div className="bg-white p-12 rounded-3xl shadow-xl max-w-2xl w-full border border-gray-100">
        <h1 className="text-4xl md:text-5xl font-heading font-bold text-primary mb-6">Sports Page</h1>
        <p className="text-lg text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
          This is a placeholder for the Sports section of the Sports Association portal. It will be fully implemented soon with rich aesthetics.
        </p>
